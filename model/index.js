...
class User {
    ...
    fetchUsers(req, res) {
        const fetchAllUsersQuery = `select firstName, lastName, emailAdd, password FROM Users;`;
    ...
    fetchUser(req, res) {
        const fetchUserQuery = `select userID, firstName, lastName, emailAdd, password FROM Users where userID = ?;`;
